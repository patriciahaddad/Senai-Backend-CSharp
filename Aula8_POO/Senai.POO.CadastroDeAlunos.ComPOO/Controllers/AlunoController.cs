...
namespace Senai.POO.CadastroDeAlunos.ComPOO.Controllers  //instanciar o objeto Model
{
    public class AlunoController
    {
        AlunoModel al = new AlunoModel();  //chamar as propriedades da pasta Model e escolher qual nome quer dar
